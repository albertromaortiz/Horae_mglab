...
@section('content_header')
  <h1>
    ...
    <h2><a href= /admin/users/create class="btn btn-block btn-success btn-xs"><i class="fa fa-plus"></i> Añadir </a></h2>
...
@foreach ($users as $user)
  ...
  <tr>
    ...
    <td>{{ link_to_route('users.edit', 'Editar', array($user->id), array('class' => 'btn btn btn-warning btn-xs')) }}
